...
function showEndScreen() {
    ...
    document.getElementById('amount-of-questions').innerHTML = questionsHTML.length;
...
function updateProgressBar() {
    let percent = currentQuestion / questionsHTML.length;     // Berechnung der Prozentzahl für eine Frage
