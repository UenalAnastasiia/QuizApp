...
function init() {
    ...
    document.getElementById('js-link').style = 'color: #ba3228; background-color: #ffffffa6; border-left: 6px solid white';
...
function showEndScreen() {
    ...
    document.getElementById('amount-of-questions').innerHTML = questionsJS.length;
...
function updateProgressBar() {
    let percent = currentQuestion / questionsJS.length;     // Berechnung der Prozentzahl für eine Frage
